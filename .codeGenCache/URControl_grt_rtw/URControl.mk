###########################################################################
## Makefile generated for Simulink model 'URControl'. 
## 
## Makefile     : URControl.mk
## Generated on : Tue Jun 30 13:36:39 2020
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/URControl
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/URControl
...
INCLUDES_BUILDINFO = -I$(START_DIR)/slprj/grt/URControl_att_indi_simple -I$(START_DIR) -I$(START_DIR)/URControl_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(START_DIR)/slprj/grt/_sharedutils
...
DEFINES_STANDARD = -DMODEL=URControl -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/URControl_grt_rtw/URControl.cpp $(START_DIR)/URControl_grt_rtw/URControl_data.cpp
...
OBJS = URControl.o URControl_data.o
...
MODELREF_LIBS = ../slprj/grt/URControl_att_indi_simple/URControl_att_indi_simple_rtwlib.a
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MODELREF_LIBS) $(LIBS) $(MAIN_OBJ)
	...
	$(CPP_LD) $(CPP_LDFLAGS) -o $(PRODUCT) $(OBJS) $(MAIN_OBJ) -Wl,--start-group ../slprj/grt/URControl_att_indi_simple/URControl_att_indi_simple_rtwlib.a -Wl,--end-group -Wl,--start-group $(LIBS) -Wl,--end-group $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
...
%.o : $(START_DIR)/URControl_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/URControl_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
