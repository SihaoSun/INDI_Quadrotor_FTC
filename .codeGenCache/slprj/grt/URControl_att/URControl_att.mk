###########################################################################
## Makefile generated for Simulink model 'URControl_att'. 
## 
## Makefile     : URControl_att.mk
## Generated on : Thu Dec 19 17:18:12 2019
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: ./URControl_att_rtwlib.a
...
MODELLIB                  = URControl_att_rtwlib.a
...
PRODUCT = ./URControl_att_rtwlib.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/slprj/grt/URControl_att -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(START_DIR)/slprj/grt/_sharedutils
...
SRCS = $(START_DIR)/slprj/grt/URControl_att/URControl_att.cpp $(START_DIR)/slprj/grt/URControl_att/URControl_att_data.cpp
...
OBJS = URControl_att.o URControl_att_data.o
...
%.o : $(START_DIR)/slprj/grt/URControl_att/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/grt/URControl_att/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
