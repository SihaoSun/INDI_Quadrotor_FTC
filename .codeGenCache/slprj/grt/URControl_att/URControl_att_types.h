...
/* Custom Type definition for MATLAB Function: '<S2>/control allocator' */
#ifndef typedef_LPFilter_1_URControl_att_T
#define typedef_LPFilter_1_URControl_att_T
...
typedef struct {
  ...
  real_T maxLim;
  real_T minLim;
} LPFilter_1_URControl_att_T;

#endif                                 /*typedef_LPFilter_1_URControl_att_T*/

#ifndef struct_emxArray_real_T_10x15
#define struct_emxArray_real_T_10x15

struct emxArray_real_T_10x15
{
  real_T data[150];
  int32_T size[2];
};

#endif                                 /*struct_emxArray_real_T_10x15*/

#ifndef typedef_emxArray_real_T_10x15_URContr_T
#define typedef_emxArray_real_T_10x15_URContr_T

typedef struct emxArray_real_T_10x15 emxArray_real_T_10x15_URContr_T;

#endif                               /*typedef_emxArray_real_T_10x15_URContr_T*/

#ifndef struct_sutwIvTFJo6gO8EeHYBaNSF_tag
#define struct_sutwIvTFJo6gO8EeHYBaNSF_tag

struct sutwIvTFJo6gO8EeHYBaNSF_tag
{
  emxArray_real_T_10x15_URContr_T f1;
};

#endif                                 /*struct_sutwIvTFJo6gO8EeHYBaNSF_tag*/

#ifndef typedef_b_cell_wrap_0_URControl_att_T
#define typedef_b_cell_wrap_0_URControl_att_T

typedef struct sutwIvTFJo6gO8EeHYBaNSF_tag b_cell_wrap_0_URControl_att_T;

#endif                                 /*typedef_b_cell_wrap_0_URControl_att_T*/

/* Custom Type definition for MATLAB Function: '<S2>/control allocator' */
#ifndef typedef_LPFilter_URControl_att_T
#define typedef_LPFilter_URControl_att_T
...
typedef struct {
  ...
  real_T maxLim;
  real_T minLim;
} LPFilter_URControl_att_T;

#endif                                 /*typedef_LPFilter_URControl_att_T*/

#ifndef typedef_SimpleDerivative_URControl_at_T
#define typedef_SimpleDerivative_URControl_at_T

typedef struct {
  real_T prevValue[3];
  real_T derValue[3];
  LPFilter_URControl_att_T filterHandle;
} SimpleDerivative_URControl_at_T;

#endif                               /*typedef_SimpleDerivative_URControl_at_T*/

#ifndef typedef_LPFilter_2_URControl_att_T
#define typedef_LPFilter_2_URControl_att_T
...
typedef struct {
  ...
  real_T maxLim;
  real_T minLim;
} LPFilter_2_URControl_att_T;

#endif                                 /*typedef_LPFilter_2_URControl_att_T*/

/* Forward declaration for rtModel */
typedef struct tag_RTM_URControl_att_T RT_MODEL_URControl_att_T;

#endif                                 /* RTW_HEADER_URControl_att_types_h_ */
