...
MODEL                   = rtwshared
MODULES                 = URTrajCalc_6eliAit3.c abs_zZTxck9n.c eps_0ubcMMgU.c norm_BC4t9Zak.c norm_MbiXjGcc.c pinv_9fLArOC2.c rtGetInf.c rtGetNaN.c rt_nonfinite.c sqrt_QJe0JoyR.c sum_n7Ci4vKg.c svd_sWXtg7f2.c xaxpy_DFWrG79F.c xaxpy_Th9vy04w.c xaxpy_yKfc9eiG.c xdotc_oQ8cd8io.c xnrm2_B4ZusOnR.c xnrm2_HfWc8I0M.c xrot_aTCg27QX.c xrotg_dvm63JYW.c xscal_d9mznQDv.c xswap_l44VPZjd.c
PRODUCT                 = rtwshared.a
MAKEFILE                = 
...
NCSTATES                = 0
COMPUTER                = GLNXA64
BUILDARGS               =  GENERATE_ASAP2=0 OPTS="-DMATLAB_MEX_FILE"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
